...
indici_possibili_comune = utils.list_duplicates_of(comune, comune_input_2)
indici_possibili_provincia = utils.list_duplicates_of(provincia, provincia_input_2)
...
codice_catastale = codici_catastale[indice]
